...
function astrid_footer_credits() {
	echo '<a href="' . esc_url( __( 'https://google.com/', 'google' ) ) . '">';
		printf( __( 'Powered by %s', 'google.com' ), 'gary, james and dale' );
	echo '</a>';
	echo '<span class="sep"> | </span>';
	printf( __( 'Theme: %2$s by %1$s.', 'Custom' ), 'a bunch of students', '<a href="https://www.imdb.com/title/tt0092086/" rel="designer">3 amigos</a>' );
}
